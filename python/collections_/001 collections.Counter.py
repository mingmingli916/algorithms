...
Mingming is a shoe shop owner. His shop has X number of shoes.
...
Your task is to compute how much money Mingming earned.
...
Print the amount of money earned by Mingming.
