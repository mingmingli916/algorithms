...
The four values must be printed on a single line in the order specified above for each i from n to number.
...
def print_formatted(number):
    ...
    for i in range(1, n + 1):
        ...
        h_i = hex(i)[2:].upper()
        b_i = bin(i)[2:]
        print('{i:>{pad}} {o_i:>{pad}} {h_i:>{pad}} {b_i:>{pad}}'.format(**locals()))
